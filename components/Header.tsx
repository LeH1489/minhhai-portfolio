...
} from "@/context/ActiveSectionContextProvider";
...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      ></motion.div>
      <nav
        className="flex fixed top-[0.15rem] left-1/2 h-12 py-2 -translate-x-1/2 
        sm:top-[1.7rem]
        sm:h-[initial]
        sm:py-0
      "
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-gray-200/60 rounded-full absolute inset-0 -z-10 dark:bg-gray-600"
